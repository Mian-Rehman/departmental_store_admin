...
import com.rehman.newtrends.OrderAdapter.SuccessOrderAdapter;
...
public class SuccessBookingFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_success_booking, container, false);
    ...
    private void showDataInRecycleView()
    {
        ...
        adapter = new SuccessOrderAdapter(getActivity(),mDataList);
        ...
        reference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                ...
                if (snapshot.exists())
                {
                    ...
                    if (snapshot.child("orderType").getValue().equals("success"))
                    {
