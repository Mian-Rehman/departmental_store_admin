...
import com.rehman.newtrends.OrderAdapter.PendingBookingAdapter;
...
public class PendingBookingFrag extends Fragment {
        ...
        reference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                ...
                if (snapshot.exists())
                {
                    ...
                    if (snapshot.child("orderType").getValue().equals("pending"))
                    {
