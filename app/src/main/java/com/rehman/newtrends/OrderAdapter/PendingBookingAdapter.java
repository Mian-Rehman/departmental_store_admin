...
public class PendingBookingAdapter extends RecyclerView.Adapter<PendingBookingAdapter.MyViewHolder>{
    ...
    public PendingBookingAdapter(Context context, List<AddressModel> mDataList) {
    ...
    @NonNull
    @Override
    public PendingBookingAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull PendingBookingAdapter.MyViewHolder holder, int position) {

        AddressModel model = mDataList.get(position);

        if (model.getOrderType().equals("pending"))
        {
